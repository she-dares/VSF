...
class LineDimLoad(Task):
    ...
    def run(self):
        dtype_dic = {"MDN": "object", "DEVICE_GROUPING": "object", "SALES_CHANNEL": "object"}
        dsk = self.input()["line_dim"].read_dask(
             dtype=dtype_dic,
        )
...
class AccountDimLoad(Task):
    ...
    def run(self):
        dtype_dic = {"CUST_ACCT": "object", "SEGMENT_NAME": "object", "SVC_PLAN": "object"}
        dsk = self.input()["account_dim"].read_dask(
             dtype=dtype_dic,
        )
...
class LimitFactLoad(Task):
    ...
    def run(self):
        dtype_dic = {"MTN": "object", "CUST_ACCT": "object", "LIMITING_DT":"object", "LIMIT_TYPE": "object"}
        dsk = self.input()["limit_fact"].read_dask(
             dtype=dtype_dic,
        )
